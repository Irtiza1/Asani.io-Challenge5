...
//   const getMotorImage = (percentage) => {
//     if (percentage === 100) return '/assets/images/Motor1.png';
...
//       setChartData((prevData) => {
//         const updatedData = [...prevData];
//         // updatedData[0].data.push(Math.floor(Math.random() * 100)); // Simulate random data for 2024
//         updatedData[1].data.push(Math.floor(Math.random() * 100)); // Simulate random data for 2025
//         updatedData[2].data.push(Math.floor(Math.random() * 100)); // Simulate random data for Team C
