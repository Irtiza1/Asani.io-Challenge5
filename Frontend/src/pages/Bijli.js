...
//           : prevData.map((data) => Math.floor(Math.random() * 100));
//       });
...
//           ...item,
//           value: Math.floor(Math.random() * 100), // Random appliance usage
//         }));
//       });
...
//       setVoltage(Math.floor(Math.random() * 100) + 100); // Simulate Voltage between 100-199
//       setCurrent(Math.floor(Math.random() * 50) + 50); // Simulate Current between 50-99
//       setEnergyConsumption(Math.floor(Math.random() * 200) + 100); // Simulate Energy Consumption between 100-300
//       setPower(Math.floor(Math.random() * 100) + 50); // Simulate Power between 50-150
//     }, 1000); // Update every second
